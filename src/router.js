...
const routes = [
  {
    ...
    meta: {
      ...
      metaTags: [
        ...
        { property: 'og:image', content: '/share-main.jpg' },
        { property: 'og:image:secure_url', content: '/share-main.jpg' },
        ...
        { name: 'twitter:image', content: '/share-main.jpeg' },
      ],
    },
    component: Home,
  },
  {
    ...
    meta: {
      ...
      metaTags: [
        ...
        { name: 'twitter:title', content: 'Volodymyr Ishchenko' },
        { name: 'twitter:description', content: 'Front-end developer, UI/UX designer.' },
        { name: 'twitter:image', content: '/share-main.jpg' },
      ],
    },
    component: CV,
  },
  {
    ...
    meta: {
      ...
      metaTags: [
        ...
        { property: 'og:image', content: '/share-drone.jpg' },
        { property: 'og:image:secure_url', content: '/share-drone.jpg' },
        { property: 'og:image:width', content: '1200' },
        { property: 'og:image:height', content: '628' },
        ...
        { name: 'twitter:image', content: '/share-drone.jpg' },
      ],
    },
    component: Donate,
  },
